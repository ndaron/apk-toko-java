 ...
 * @author putra
 */
public class ambilbarangmasuk extends javax.swing.JFrame {

    public barangmasuk fAB = null;
    /**
     * Creates new form ambilbarangmasuk
     */
    public ambilbarangmasuk() {
        initComponents();
    }
   ...
   String sql = "select id_barang, nama_barang, pakaian, ukuran, brand,  warna from barang where id_barang like '%"+ jid.getText() + "%'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ambilbarangmasuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ambilbarangmasuk().setVisible(true);
            }
        });
    }
